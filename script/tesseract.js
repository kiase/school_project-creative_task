    ...
    return function(e) {
            ...
            var P = function(e, t) {
                ...
                E = function(e) {
                    ...
                    return new Promise((function(e, i) {
                        p("[".concat(t, "]: Start ").concat(r, ", action=").concat(n)), P(n, e), S(n, i), O(k, {
                            workerId: t,
                            jobId: r,
                            action: n,
                            payload: o
        ...
        (function(e) {
            ...
            var r = function(e) {
                ...
                return b.prototype = j.constructor = v, v.constructor = b, v[u] = b.displayName = "GeneratorFunction", e.isGeneratorFunction = function(e) {
                ...
                }, x(k.prototype), k.prototype[c] = function() {
                    return this
                }, e.AsyncIterator = k, e.async = function(t, r, n, o) {
                    var i = new k(s(t, r, n, o));
                    return e.isGeneratorFunction(r) ? i : i.next().then((function(e) {
                        return e.done ? e.value : i.next()
                    }))
                }, x(j), j[u] = "Generator", j[a] = function() {
                    return this
                }, j.toString = function() {
            ...
            var l = function() {
                ...
                d = function(t, s) {
                    return new Promise((function(f, l) {
                        ...
                        }()), u("[".concat(e, "]: Add ").concat(d.id, " to JobQueue")), u("[".concat(e, "]: JobQueue length=").concat(i.length)), p()
                    }))
                };
            return {
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 25:
                                ...
                                return e.next = 28, new Promise((function(e) {
                                    t.toBlob(function() {
